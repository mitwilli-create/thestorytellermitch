...
- Before reviewing or rewriting a page, read the complete file and inspect every user-facing string, including navigation, labels, cards, captions, links, and hidden or lower-page sections. Mitchell explicitly requires whole-page review before copy council work. <!-- id:8b688d9f31 evidence:4 -->
- When Mitchell requests a copy council, run the complete named protocol in order, preserve distinct competing rewrites, give proof veto power, and mark proof or voice gaps instead of blending the work into consensus language. <!-- id:0d4b7c9a21 evidence:4 -->
- For editorial research and distribution planning, cover the relevant web, Reddit, X, Hacker News, and other accessible social surfaces, distinguish active conversations from saturated ones, cite direct evidence, identify objections, and state whether each proposed placement fits. <!-- id:4f7a2c8e60 evidence:3 -->
