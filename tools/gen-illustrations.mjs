...
const JOBS = [
  ...
  ['illo-broll-pipeline.jpg', `${BOLD} Subject: an assembly line seen side-on: a flat document sheet enters at the left, passes through seven large connected machine chambers in a row, and exits at the right transformed into a framed video screen with a thick caption bar underneath it; inside the chambers the material visibly changes stage by stage from lines of a page, to a large audio waveform, to picture frames, to a film strip; the caption-bar chamber glows oxblood.`],
